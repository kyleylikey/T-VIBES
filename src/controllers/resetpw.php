        ...
        <div class='card shadow-lg' style='width: 30rem; height: 30rem; padding: 2rem;'>
            <div class='card-body'>
                ...
                <form action='resetpassword.php' method='POST'>
                    ...
                    <button type='submit' class='btn btn-submit w-auto px-4 py-2 rounded-pill d-block mx-auto'>Submit</button>
                </form>
            </div>
        </div>
...
<script>
    ...
    echo "<script>alert('Invalid or expired token. Please request a new password reset.'); window.location.href = ' window.location.href = '/T-Vibes/src/frontend/login.php';';</script>";
}
?>
