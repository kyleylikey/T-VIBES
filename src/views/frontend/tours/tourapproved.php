...
<meta charset="UTF-8" />
    ...
    <title>Tour Approved - Taal Heritage Town</title>
    ...
    <style>
        ...
        /* Tour Row Styling - Approved Style */
        .tour-row {
            background-color: #E7EBEE;
            padding: 18px 20px;
            margin-bottom: 0;
            border-left: 4px solid #3CE745; /* Green border for approved tours */
            transition: all 0.3s ease;
            border-bottom: 1px solid rgba(60, 231, 69, 0.15);
        }

        .tour-row:hover {
            background-color: #e0f3e1; /* Slight green tint on hover */
        ...
        .people-count {
            ...
            background-color: #3CE745; /* Green for approved */
            color: #102E47;
            border-radius: 50px;
            padding: 3px 15px;
            font-weight: 600;
        ...
        .destinations-list li:before {
            content: "✓"; /* Checkmark for approved tours */
            position: absolute;
            left: 0;
            top: 0;
            color: #3CE745;
        ...
        .status-approved {
            background-color: rgba(60, 231, 69, 0.15);
            color: #0e8918;
        }
        ...
        .modal-footer .text-success:before {
            color: #3CE745;
            font-size: 24px;
        }
