...
<div class="dashboardcontainer">
    <div class="content">
        ...
        <button class="bluebuttonactive">Today</button>
        <button class="bluebuttonnotactive" onclick="window.location.href='upcomingtoursall.php'">All</button>
        <div class="requestlists">
            <div class="containertours">
                <div class="left-side">
                    <div class="tour-container" onclick="toggleActive(this)">
                        <h4>Mr. Juan Dela Cruz</h4>
                        <p>3 Sites</p>
                    </div>
                    <div class="tour-container" onclick="toggleActive(this)">
                        <h4>Mr. Jose Cruz</h4>
                ...
                <div class="right-side">
                    ...
                    <h4 style="margin-left: 30px;">Mr. Juan Dela Cruz</h4>
                    <p class="indented">Taal Church</p>
                    <p class="indented">Goco Ancestral House</p>
                    <p class="indented">Sacred Well of Sta. Lucia</p>
                    <br>
